                    ...
                    if (!rowspan || !colspan) {
                      ...
                      if (colspan !== 1) {
                        ...
                        for (let i = 0; i < colspan; i++) {
                          const spanColumn = this.columns[cellIndex + i];
                          if (!spanColumn) {
                            continue;
                          }

                          let spanRealWidth = spanColumn.spanRealWidth;
                          let spanWidth = spanColumn.width;
                          if (spanWidth === undefined) {
                            spanWidth = 0;
                            width = null;
                          }
                          if (spanRealWidth === null) {
                            spanRealWidth = spanWidth;
                          }
                          realWidth += spanRealWidth;
                          if (width !== null) {
                            width += spanWidth;
                          }
                        }
                        ...
                        columnData.realWidth = realWidth;
