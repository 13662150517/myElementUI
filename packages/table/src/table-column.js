...
export default {
    ...
    setColumnRenders(column) {
      ...
      if (column.type === 'expand') {
        ...
        column.renderCell = (h, data) => {
          ...
          if (column.autoWidth) {
            props.class += ' el-auto-width';
            return (<div { ...props }>
              <span class="el-cell-text">
                { prefix }
                { children }
              </span>
            </div>);
  ...
  created() {
    ...
    const basicProps = ['columnKey', 'label', 'className', 'labelClassName', 'type', 'renderHeader', 'resizable', 'formatter', 'fixed', 'resizable', 'autoWidth', 'hidden'];
